...
router.get("/local_users", async (req, res) => {
  try {
...
router.get("/local_users/:id", async (req, res) => {
  try {
...
router.post("/local_users", async (req, res) => {
  try {
...
router.put("/local_users/:id", async (req, res) => {
  try {
...
router.delete("/local_users/:id", async (req, res) => {
  try {
